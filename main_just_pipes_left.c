...
/*   Updated: 2024/08/09 16:52:21 by ehedeman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	command_involves_pipes(t_statement *parsed_input)
{
	t_statement	*current;
...
static void	create_pipes(t_statement *current, int pipefd[])
{
...
static void	child_process(t_statement *curr, t_mini *mini, int in_fd, int pipefd[])
{
